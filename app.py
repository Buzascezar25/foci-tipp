...
# A 72 csoportmeccs zászlókkal
ALAP_MECCSEK = [
    "Mexikó 🇲🇽 - Dél-Afrika 🇿🇦", "Dél-Korea 🇰🇷 - Csehország 🇨🇿", "Kanada 🇨🇦 - Bosznia-Hercegovina 🇧🇦", "Katar 🇶🇦 - Svájc 🇨🇭",
    "Brazília 🇧🇷 - Marokkó 🇲🇦", "Haiti 🇭🇹 - Skócia 🏴󠁧󠁢󠁳󠁣󠁴󠁿", "USA 🇺🇸 - Paraguay 🇵🇾", "Ausztrália 🇦🇺 - Törökország 🇹🇷",
    "Németország 🇩🇪 - Curaçao 🇨🇼", "Elefántcsontpart 🇨🇮 - Ecuador 🇪🇨", "Hollandia 🇳🇱 - Japán 🇯🇵", "Svédország 🇸🇪 - Tunézia 🇹🇳",
    "Belgium 🇧🇪 - Egyiptom 🇪🇬", "Irán 🇮🇷 - Új-Zéland 🇳🇿", "Spanyolország 🇪🇸 - Zöld-foki-szigetek 🇨🇻", "Szaúd-Arábia 🇸🇦 - Uruguay 🇺🇾",
    "Franciaország 🇫🇷 - Szenegál 🇸🇳", "Irak 🇮🇶 - Norvégia 🇳🇴", "Argentína 🇦🇷 - Algéria 🇩🇿", "Ausztria 🇦🇹 - Jordánia 🇯🇴",
    "Portugália 🇵🇹 - Kongói DK 🇨🇩", "Üzbegisztán 🇺🇿 - Kolumbia 🇨🇴", "Ghána 🇬🇭 - Panama 🇵🇦", "Anglia 🏴󠁧󠁢󠁥󠁮󠁧󠁿 - Horvátország 🇭🇷",
    "Csehország 🇨🇿 - Dél-Afrika 🇿🇦", "Mexikó 🇲🇽 - Dél-Korea 🇰🇷", "Svájc 🇨🇭 - Bosznia-Hercegovina 🇧🇦", "Kanada 🇨🇦 - Katar 🇶🇦",
    "Skócia 🏴󠁧󠁢󠁳󠁣󠁴󠁿 - Marokkó 🇲🇦", "Brazília 🇧🇷 - Haiti 🇭🇹", "Törökország 🇹🇷 - Paraguay 🇵🇾", "USA 🇺🇸 - Ausztrália 🇦🇺",
    "Ecuador 🇪🇨 - Curaçao 🇨🇼", "Németország 🇩🇪 - Elefántcsontpart 🇨🇮", "Tunézia 🇹🇳 - Japán 🇯🇵", "Hollandia 🇳🇱 - Svédország 🇸🇪",
    "Új-Zéland 🇳🇿 - Egyiptom 🇪🇬", "Belgium 🇧🇪 - Irán 🇮🇷", "Uruguay 🇺🇾 - Zöld-foki-szigetek 🇨🇻", "Spanyolország 🇪🇸 - Szaúd-Arábia 🇸🇦",
    "Norvégia 🇳🇴 - Szenegál 🇸🇳", "Franciaország 🇫🇷 - Irak 🇮🇶", "Jordánia 🇯🇴 - Algéria 🇩🇿", "Argentína 🇦🇷 - Ausztria 🇦🇹",
    "Kolumbia 🇨🇴 - Kongói DK 🇨🇩", "Portugália 🇵🇹 - Üzbegisztán 🇺🇿", "Horvátország 🇭🇷 - Panama 🇵🇦", "Ghána 🇬🇭 - Anglia 🏴󠁧󠁢󠁥󠁮󠁧󠁿",
    "Csehország 🇨🇿 - Mexikó 🇲🇽", "Dél-Afrika 🇿🇦 - Dél-Korea 🇰🇷", "Svájc 🇨🇭 - Kanada 🇨🇦", "Bosznia-Hercegovina 🇧🇦 - Katar 🇶🇦",
    "Skócia 🏴󠁧󠁢󠁳󠁣󠁴󠁿 - Brazília 🇧🇷", "Marokkó 🇲🇦 - Haiti 🇭🇹", "Törökország 🇹🇷 - USA 🇺🇸", "Paraguay 🇵🇾 - Ausztrália 🇦🇺",
    "Ecuador 🇪🇨 - Németország 🇩🇪", "Curaçao 🇨🇼 - Elefántcsontpart 🇨🇮", "Tunézia 🇹🇳 - Hollandia 🇳🇱", "Japán 🇯🇵 - Svédország 🇸🇪",
    "Új-Zéland 🇳🇿 - Belgium 🇧🇪", "Egyiptom 🇪🇬 - Irán 🇮🇷", "Uruguay 🇺🇾 - Spanyolország 🇪🇸", "Zöld-foki-szigetek 🇨🇻 - Szaúd-Arábia 🇸🇦",
    "Norvégia 🇳🇴 - Franciaország 🇫🇷", "Szenegál 🇸🇳 - Irak 🇮🇶", "Jordánia 🇯🇴 - Argentína 🇦🇷", "Algéria 🇩🇿 - Ausztria 🇦🇹",
    "Kolumbia 🇨🇴 - Portugália 🇵🇹", "Kongói DK 🇨🇩 - Üzbegisztán 🇺🇿", "Horvátország 🇭🇷 - Ghána 🇬🇭", "Panama 🇵🇦 - Anglia 🏴󠁧󠁢󠁥󠁮󠁧󠁿"
]

# A kieséses szakasz logikai ágrajza (Képek alapján)
KO_ALAP_STRUKTURA = {
...
# ==========================================
# 2. ADATBÁZIS ÉS LOGIKAI FÜGGVÉNYEK
# ==========================================
def load_data():
    if os.path.exists(DB_FILE):
        with open(DB_FILE, "r", encoding="utf-8") as f:
            adat = json.load(f)
            # Kompatibilitás a korábbi verzióval (Hozzáadjuk a KO szakaszt, ha még nem volt)
...
# Kieséses szakasz pontszámító (Csoportkör logika + 1 pont a továbbjutóért)
def ko_pont_szamit(valos_h, valos_v, valos_tovabb, tipp_h, tipp_v, tipp_tovabb):
    ...
    # Plusz 1 pont, ha eltalálta a továbbjutót
    plusz_pont = 1 if (valos_tovabb == tipp_tovabb) else 0
    
    return alap_pont + plusz_pont, telitalalat

# Dinamikus ágrajz építő (meghatározza a TBD helyett a bejutó csapatokat)
def get_aktualis_bracket():
    bracket = copy.deepcopy(KO_ALAP_STRUKTURA)
    # Az egyes fordulókon sorban haladunk végig, hogy átvigyük a nyerteseket
        ...
        for m_id, m_adat in bracket.items():
            if m_id.startswith(szakasz):
                if m_id in data.get("ko_eredmenyek", {}):
                    ...
                    tovabbjuto = eredmeny.get("tovabbjuto") # 1 (hazai) vagy 2 (vendeg)
                    
                    gyoztes = None
                    if tovabbjuto == 1:
                        gyoztes = m_adat["hazai"]
                    elif tovabbjuto == 2:
                        gyoztes = m_adat["vendeg"]
                        
                    # Ha megvan a győztes, bedobjuk a következő meccsbe
...
if menu == " Ranglista és Meccsek":
    ...
    # Fő ranglista megjelenítése a lap tetején (mindkét fülön látszik)
    ranglista_adatok = [{"Játékos": j, "Összes pont": osszes_pont[j], "Telitalálatok": telitalalatok[j]} for j in jatekosok]
    ranglista_df = pd.DataFrame(ranglista_adatok).sort_values(by=["Összes pont", "Telitalálatok"], ascending=[False, False])
    ...
    with tab2:
        ...
        for m_id, bracket_adat in aktualis_bracket.items():
            ...
            if v_h is not None:
                tovabbjuto_nev = bracket_adat['hazai'] if v_tovabb == 1 else bracket_adat['vendeg']
                eredmeny_szoveg = f"{v_h}-{v_v} (Tovább: {tovabbjuto_nev})"
            else:
    ...
    # --- EGYENES KIESÉS FÜL ---
    with tab2:
        # Csak olyan meccsek, ahol már ismert mindkét csapat, de még nincs valós eredménye
        ...
        if not ko_aktiv:
            ...
            if st.button("Kieséses Tippek mentése ", type="primary"):
                ...
                for m_id, b_adat in ko_aktiv.items():
                    ...
                    tov_kivalasztva = st.session_state.get(f"ko_tovabb_val_{valasztott_jatekos}_{m_id}", "Válassz...")
                    
                    tovabb_szam = 1 if tov_kivalasztva == b_adat["hazai"] else (2 if tov_kivalasztva == b_adat["vendeg"] else 0)
                    
                    data["ko_tippek"][valasztott_jatekos][m_id] = {"h": h_ertek, "v": v_ertek, "tovabbjuto": tovabb_szam}
            ...
            for m_id, m_adat in ko_aktiv.items():
                ...
                elozo_tipp = data.get("ko_tippek", {}).get(valasztott_jatekos, {}).get(m_id, {"h":0, "v":0, "tovabbjuto":0})
                opciok = ["Válassz...", m_adat["hazai"], m_adat["vendeg"]]
                def_idx = elozo_tipp["tovabbjuto"] if elozo_tipp["tovabbjuto"] in [1, 2] else 0
                
                col1, col2, col3 = st.columns([1, 1, 2])
                with col1: st.number_input(f"Hazai Gól", min_value=0, max_value=20, value=int(elozo_tipp["h"]), key=f"ko_h_{valasztott_jatekos}_{m_id}")
                with col2: st.number_input(f"Vendég Gól", min_value=0, max_value=20, value=int(elozo_tipp["v"]), key=f"ko_v_{valasztott_jatekos}_{m_id}")
                with col3: st.selectbox(f"Kijut tovább?", opciok, index=def_idx, key=f"ko_tovabb_val_{valasztott_jatekos}_{m_id}")
                st.write("---")
    ...
    with tab2:
        ...
        st.info("Amikor lezársz egy meccset és kiválasztod a továbbjutót, a rendszer automatikusan beteszi a nyertest a következő fordulóba!")
